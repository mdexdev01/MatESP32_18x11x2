  ...
  while(true) {
    ...
    if(read_len < (PACKET_LEN_TYPE0 - 1)) {
      ...
      if(PACKET_LEN_TYPE0 < read_len) {
        ...
        //println("read_len = " + read_len + " of " + available_len + "PACK:" + PACKET_LEN_TYPE0
        //          + " [0]" + PacketRawData[jitter] + "[1]" + PacketRawData[jitter+1] + "  [read_len-2]" + PacketRawData[read_len-2] + "[read_len-1]" + PacketRawData[read_len-1]);
