...
class EditRect {
  ...
  void showInt(int v){
    try {
      ...
      pop();
        ...
        System.out.println("NullPointerException showInt");
    }
  }                                                                            
  void showFloat(float v){
    try {
        ...
        System.out.println("NullPointerException showFloat");
    }
  }
  void showString(String s){
    try {
      ...
      pop();
        ...
        System.out.println("NullPointerException showString");
    }
  }
}
