...
void setup() {
    ...
    for (int i = 0; i < 4; i++) {
        ...
        strip[i].setBrightness(250);  // Set BRIGHTNESS to about 1/5 (max = 255)
    }

    strip[3].updateLength(132);
...
void blurObjectOutline() {
    ...
    for (int y = 0; y < 15; y++) {
        for (int x = 0; x < 15; x++) {
            ...
            blurLEDwithADCPos(15, x, -1, 15, y, -1);
            blurLEDwithADCPos(15, x, -1, 15, y, 0);
            blurLEDwithADCPos(15, x, -1, 15, y, 1);

            blurLEDwithADCPos(15, x, 0, 15, y, -1);
            // blurLEDwithADCPos(15, x,  0, 15, y,  0);
            blurLEDwithADCPos(15, x, 0, 15, y, 1);
