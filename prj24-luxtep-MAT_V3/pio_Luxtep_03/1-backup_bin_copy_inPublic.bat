...
:: 작업 디렉토리 설정
set targetdir=d:\coding\MatESP32_18x11x2\prj25-espidf-examples\firebase-ota-server\public
set sourcedir=.\.pio\build\esp32s3
...
copy %sourcedir%\firmware.bin %targetdir%\firmware.bin
