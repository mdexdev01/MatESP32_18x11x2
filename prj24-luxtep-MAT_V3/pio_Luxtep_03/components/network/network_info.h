...
// --- WiFi AP 정보 ---
const char* WIFI_SSID = "KT_GiGA_2G_Wave2_4587";
const char* WIFI_PASSWORD = "fab8ezx455";

// --- TCP 서버 포트 ---
const uint16_t TCP_SERVER_PORT = 9000;

// --- HiveMQ Cloud MQTT 설정 ---
const char* MQTT_BROKER = "385a0883b81e4fef92e75a06365fb8e6.s1.eu.hivemq.cloud";
const int MQTT_PORT = 8883;
const char* MQTT_USERNAME = "luxtep_mat_V1";
const char* MQTT_PASSWORD = "Lluxtep8*";
